  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 4.5C2 3.39543 2.89543 2.5 4 2.5H12C13.1046 2.5 14 3.39543 14 4.5V5H12H4H2V4.5ZM2 6V12.5C2 13.8807 3.11929 15 4.5 15H11.5C12.8807 15 14 13.8807 14 12.5V10.5C14 9.39543 13.1046 8.5 12 8.5H11C10.1716 8.5 9.5 9.17157 9.5 10C9.5 10.8284 10.1716 11.5 11 11.5H12C12.2761 11.5 12.5 11.7239 12.5 12V12.5C12.5 13.0523 12.0523 13.5 11.5 13.5H4.5C3.94772 13.5 3.5 13.0523 3.5 12.5V6H2ZM12 10H11C10.7239 10 10.5 10.2239 10.5 10.5C10.5 10.7761 10.7239 11 11 11H12C12.2761 11 12.5 10.7761 12.5 10.5C12.5 10.2239 12.2761 10 12 10Z"
        fill="currentColor"
      ></path>
    </svg>
  );
